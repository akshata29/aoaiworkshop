...
# This is a list of acronyms and their corresponding definitions. The acronyms are related to various financial terms and institutions. The list includes acronyms such as ABS (Asset-backed securities), HTM (Held-to-maturity), AFS (Available-for-sale), ICAAP (Internal Capital Adequacy Assessment Process), ALM (Asset and liability management), and many more.
