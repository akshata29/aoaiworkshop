...
# START OF CODE BLOCK eb2ae0af

# Summary of the TEXT EXTRACT:
# This text extract provides information about the earnings per common share (EPS) and diluted EPS for the years 2018, 2017, and 2016. It also includes information about the calculation of EPS, net income, preferred stock dividends, average common shares issued and outstanding, and diluted potential common shares. Additionally, it mentions the impact of warrants, options, and regulatory requirements and restrictions.
